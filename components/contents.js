...
<div className="mx-auto mt-16 max-w-7xl px-6 lg:px-8 pb-16">
      <a href="https://zedaco.de/zigaretten/" className="block">
        ...
        <div className="relative -z-10 mt-32 px-6 lg:px-8">
          ...
          <div className="mx-auto max-w-2xl text-center">
            <h2 id="cta" className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
  ...
  <a
    href="/karte"
    className="rounded-md bg-indigo-600 px-14 py-10 text-lg font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
  >
    Karte öffnen
  </a>
</div>
